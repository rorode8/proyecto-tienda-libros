...
set cb=%cd%\tstRMI_Lret.jar

if [%1] NEQ [] goto conclientes
java -jar %cb% Lanzador 10 POJOCliente 50 localhost
goto fin

:conclientes

if [%2] NEQ [] goto consolicitudes
java -jar %cb% Lanzador %1 POJOCliente 15 localhost 
goto fin

:consolicitudes
if [%3] NEQ [] goto conHost
java -jar %cb% Lanzador %1 POJOCliente %2 localhost
goto fin
